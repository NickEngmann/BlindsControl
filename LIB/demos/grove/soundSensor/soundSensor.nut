...
// Defines the ADC (analog-to-digital converter) to which the sound sensor is connected
const ADC_SOUND         = 0;
...
const SOUND_DETECT_THRESHOLD = 25;
...
while(true) {
    ...
    // If the measured sound level is above the threshold, flash the LED
